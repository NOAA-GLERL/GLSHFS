...
glshfs.o:  glshfs.f90 glshfs_util.o glshfs_global.o glerldatatypesandunits.o gl_constants.o      \
           ...
           glshfs_configfile.o glshfs_structureddata.o                                           \
...
z_test.o: z_test.f90  glshfs_util.o cpp_util.o
	$(CC) $(CFLAGS) -c z_test.f90
...
glshfs_files_newer.o: glshfs_files_newer.f90 glshfs_util.o cpp_util.o glshfs_global.o glerldatatypesandunits.o      \
                dailydatastructures.o dailydatacollections.o
	$(CC) $(CFLAGS) -c glshfs_files_newer.f90
