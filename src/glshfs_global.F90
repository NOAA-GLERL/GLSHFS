...
MODULE GLSHFS_Global
      ...
      INTEGER, PARAMETER :: MaxNumberOfStations = 11000
      ...
      TYPE GLSHFS_ConfigData
         ...
         CHARACTER(LEN=150) :: BaseDir, PrgDir, StnDir
         ...
         !
         !  Control over output of detailed info about the thiessen-weighting of the
         !  meteorology data?  This includes the cell map and weights assigned
         !  for each station.  Primarily for debugging and/or verification, but I'm
         !  sure it can be useful for other purposes.
         !
         !  This little character array will contain a 'Y' or 'N' in each position.
         !  Each entry corresponds to a data type.  The index order is the same as
         !  they appear in the subbasin meteorology files.
         !   1) AirtempMax
         !   2) AirtempMin
         !   3) Precipitation
         !   4) AirtempMean
         ...
         !   7) CloudCover
         !
         CHARACTER(LEN=1), DIMENSION(7) :: OutputMetDetails
